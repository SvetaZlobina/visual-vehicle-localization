...
for topic, msg, t in bag.read_messages():
    ...
    if topic == '/odometry/extended':
        ...
        if odom_zero_x is None:
            ...
            angle_odom = R.from_quat([msg.odom.pose.pose.orientation.x, msg.odom.pose.pose.orientation.y, msg.odom.pose.pose.orientation.z,
...
plt.imshow(odom_matrix)
plt.imsave('odometry_track_rotated.png', odom_matrix)
